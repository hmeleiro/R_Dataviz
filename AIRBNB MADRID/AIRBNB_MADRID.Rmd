...
AIRBNB <- read_excel("https://github.com/meneos/R_Dataviz/blob/master/AIRBNB%20MADRID/Anuncios%20Airbnb%20MAD%20abril%202017.xlsx?raw=true")
AIRBNB_CAT <- read_excel("https://github.com/meneos/R_Dataviz/blob/master/AIRBNB%20MADRID/MADRID%20Airbnb%20y%20vivienda.xlsx?raw=true", sheet = "R sin formato")
VIV_PROT <- read_excel("https://github.com/meneos/R_Dataviz/blob/master/AIRBNB%20MADRID/vivienda%20protegida%20(2006-2016).xlsx?raw=true")
...
TEMA <- theme(text = element_text(family = "Roboto Condensed"),
...
TEMA_2 <- theme(text = element_text(family = "Roboto Condensed"),
               plot.title = element_text(face = "bold", size = 18),
               plot.subtitle = element_text(size = 12),
...
TOPDISTRITOS_plot + geom_col(fill = "indianred1") +
  ...
  annotate(geom = "text", 
           ...
           hjust = 0) +
  annotate(geom = "segment", x = 21.5, xend = 17, y = 6900, yend = 6900) +
