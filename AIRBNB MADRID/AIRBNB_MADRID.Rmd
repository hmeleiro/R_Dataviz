...
AIRBNB <- read_excel("Dropbox/MASTER/DATOS/MATRICES/Anuncios Airbnb MAD abril 2017.xlsx")
AIRBNB_CAT <- read_excel("Dropbox/MASTER/DATOS/OUTPUTS/EXCELS/MADRID Airbnb y vivienda.xlsx", sheet = "R sin formato")
VIV_PROT <- read_excel("Dropbox/MASTER/DATOS/OUTPUTS/EXCELS/vivienda protegida (2006-2016).xlsx")
